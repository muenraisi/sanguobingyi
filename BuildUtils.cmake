...
if(PLATFORM_WIN32 OR PLATFORM_UNIVERSAL_WINDOWS)
    ...
    function(copy_required_dlls TARGET_NAME)
        if(D3D11_SUPPORTED)
            list(APPEND ENGINE_DLLS "D:/indie/DiligentEngine/build/Win64/DiligentCore/Graphics/GraphicsEngineD3D11/Debug/GraphicsEngineD3D11_64d.dll")
        endif()
        if(D3D12_SUPPORTED)
            list(APPEND ENGINE_DLLS "D:/indie/DiligentEngine/build/Win64/DiligentCore/Graphics/GraphicsEngineD3D12/Debug/GraphicsEngineD3D12_64d.dll")
        endif()
        if(GL_SUPPORTED)
            list(APPEND ENGINE_DLLS "D:/indie/DiligentEngine/build/Win64/DiligentCore/Graphics/GraphicsEngineOpenGL/Debug/GraphicsEngineOpenGL_64d.dll")
        endif()
        if(VULKAN_SUPPORTED)
            list(APPEND ENGINE_DLLS "D:/indie/DiligentEngine/build/Win64/DiligentCore/Graphics/GraphicsEngineVulkan/Debug/GraphicsEngineVk_64d.dll")
        endif()
        if(METAL_SUPPORTED)
