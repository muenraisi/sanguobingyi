...
namespace Diligent
{
	...
	void main::CreatePipelineStates()
	{
	...
	{
		{
			...
			CreateTextureFromFile("height.png", loadInfo, m_pDevice, &HeightMap);
...

		{
			...
			CreateTextureFromFile("normal.png", loadInfo, m_pDevice, &ColorMap);
			// Get shader resource view from the texture
	...
	void main::ModifyEngineInitInfo(const ModifyEngineInitInfoAttribs& Attribs)
	{
	...
	void main::Initialize(const SampleInitInfo& InitInfo)
	{
	...
	void main::Update(double CurrTime, double ElapsedTime)
	{
